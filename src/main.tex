...
[公司|职位｜最好一次绩效]
{贝壳找房（北京）科技有限公司}
[\textnormal{业务后端研发工程师｜绩效5（2024，杰出）}]
[2022.03—至今]
\textbf{2024年全年杰出绩效}，主要业务贡献为\textbf{实时/离线标签（数据分发）系统建设、核心人事业务系统、招聘系统AI流程改造}，面向ToB的业务系统有深入的开发经验、具备丰富HiveSQL开发、离线大数据处理经验。
\begin{itemize}
  \item \textbf{独立负责实时/离线标签（数据分发）系统建设，}为人力的招聘、经纪人/职能绩效管理、企业文化、人才发展等30+系统提供标签数据支持。
